  ...
  <section id="education" className="my-8 md:my-12 w-full max-w-3xl mx-auto">
    ...
    <div className="bg-terminal rounded-lg border border-[#222] p-6 shadow-lg font-mono text-[1rem] text-foreground">
      <ul className="pl-4 list-disc space-y-2">
        <li>
          <b>
            BEng (Hons) - Top Up in Software Engineering, London Metropolitan
        ...
        <li>
          <b>
            BTEC HND in Computing - Level 5 (RQF) in Software Engineering,
            Pearson (Merit)
          </b>
          <br />
        ...
        <li>
          <b>G.C.E (A/L-2019), Physical Science Stream, Maliyadeva College</b>
          <br />
