      ...
      <div className="flex flex-col">
        {experiences.map((exp, idx) => (
          ...
          >
            ...
            >
              <div>
                <div className="font-mono text-accent text-base font-bold">
                  {exp.title}
                </div>
            ...
            >
              <ul
                className={`py-2 ${openIdx === idx ? "animate-fade-in" : ""}`}
              >
                {openIdx === idx &&
                  exp.bullets.map((bullet, bidx) => (
                    <li
                      key={bidx}
                      className="font-mono text-[1rem] text-foreground mb-2 flex items-start"
                    >
